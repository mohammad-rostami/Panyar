...
public class FragmentWaitingForPurchaseList extends Fragment
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_waiting_for_purchase_list, container, false);
        ...
        lst.setOnUpdateListener(FragmentWaitingForPurchaseList.this)
                .setOnLoadListener(FragmentWaitingForPurchaseList.this);
        lst.requestUpdate();
        ...
        img_info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("type", "waiting_for_purchase");
    ...
    public void onUpdate() {
        // do update action
        String url = App.webServiceUrl + "bime_api/approved/token/" + Utils.getInstance().getUserToken();
        Log.d("volley", "lunchRequest: " + url);
        StringRequest request = new StringRequest(Request.Method.GET, App.webServiceUrl + "bime_api/approved/token/" + Utils.getInstance().getUserToken(), new Response.Listener<String>() {
            @Override
    ...
    public class ItemAdapter extends ArrayAdapter<BimeItem> {
        ...
        public ItemAdapter(Context context, ArrayList<BimeItem> items) {
            super(context, R.layout.waiting_for_purchase_list, items);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final FragmentWaitingForPurchaseList.ViewHolder holder;
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.waiting_for_purchase_list, parent, false);
                holder = new FragmentWaitingForPurchaseList.ViewHolder();
                ...
                holder = (FragmentWaitingForPurchaseList.ViewHolder) convertView.getTag();
            }
...
//                holder.txtDsc.setVisibility(View.GONE);
            ...
            sb.append(" در انتظار پرداخت ");
            holder.txtDsc.setText(sb.toString());
